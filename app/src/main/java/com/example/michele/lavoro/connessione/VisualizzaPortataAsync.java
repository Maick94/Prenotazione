...
public class VisualizzaPortataAsync extends AsyncTask<String, Void, String> {

    private ProgressDialog loadingDialog;
    private Context context;
    private String modalita;

    public VisualizzaPortataAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link = "http://databaseandroid.altervista.org/php/Control/VisualizzaPortataControl.php"+data;
                Log.d("DEBUG:", link);
